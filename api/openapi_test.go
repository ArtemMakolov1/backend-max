...
func TestOpenAPIContainsBrowserRoutes(t *testing.T) {
	...
	assertResponseSchemaRef(t, document, "/workspaces/{workspace_id}/billing/checkout", "post", "409", "#/components/schemas/ProblemEnvelope")
	assertResponseSchemaRef(t, document, "/workspaces/{workspace_id}/billing/checkout", "post", "428", "#/components/schemas/ProblemEnvelope")
	...
	assertSchemaRequiredProperty(t, document, "BillingCheckoutRequest", "plan_version")
	assertSchemaRequiredProperty(t, document, "BillingCheckoutRequest", "monthly_price_minor")
	assertSchemaRequiredProperty(t, document, "BillingCheckoutRequest", "currency_code")
	assertSchemaRequiredProperty(t, document, "BillingCheckoutRequest", "recurring_consent_terms_version")

...
Пользователям не нужно создавать собственных ботов. В кабинете они один раз
связывают Яндекс-аккаунт со своим MAX-профилем через одноразовую deep-link
ссылку, сверяют шестизначный код и подтверждают действие кнопкой внутри MAX.
...
Клиентский сценарий использует только защищённые Яндекс-сессией методы:
